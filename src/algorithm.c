...
/*   Updated: 2023/03/21 19:35:52 by junyojeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	slope_lower_than_one(t_mlx *mlx, t_point *start, t_point *end, t_bresenham br)
{
	int	f;
...
static void	slope_upper_than_one(t_mlx *mlx, t_point *start, t_point *end, t_bresenham br)
{
	int	f;
